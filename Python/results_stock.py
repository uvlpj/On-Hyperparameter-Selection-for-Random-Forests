...
def plot_crps_vs_mtry_split(specifications_list):
    ...
    # Plot each group
    plot_group(group1, 3, 2, "Mean CRPS for different m_try values (first 6 stock datasets)")
    plot_group(group2, 4, 6, "Mean CRPS for different m_try values (remaining 24 stock datasets)")
#%%
# Call the function
...
def plot_se_vs_mtry_split(specifications_list):
    ...
    # Plot each group
    plot_group(group1, 3, 2, "RMSE for different m_try values (first 6 stock datasets)")
    plot_group(group2, 4, 6, "RMSE for different m_try values (remaining 24 stock datasets)")
#%%
# Call the function 
...
def plot_ae_vs_mtry_split(specifications_list):
    ...
    # Plot each group
    plot_group(group1, 3, 2, "MAE for different m_try values (first 6 stock datasets)")
    plot_group(group2, 4, 6, "MAE for different m_try values (remaining 24 stock datasets)")
#%%
# Call  the function
